...
class CardSliverAppBar extends StatefulWidget {
  final double? height;
  final CachedNetworkImage? background;
  ...
  @override
  CardSliverAppBarState createState() => CardSliverAppBarState();
}

class CardSliverAppBarState extends State<CardSliverAppBar>
  ...
  Widget _backButtonConstructor() {
    return Positioned(
      ...
      Column(
        children: <Widget>[
          IconButton(
            icon: Image.asset(Images.backButton, height: 30.h, width: 30.w,
            color: Colors.red,),
