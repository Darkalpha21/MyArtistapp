...
import 'package:my_artist_demo/app/utility/intl_phone_field/countries.dart';
import 'package:my_artist_demo/app/utility/intl_phone_field/country_picker_dialog.dart';
import 'package:my_artist_demo/app/utility/intl_phone_field/phone_number.dart';
...
class IntlPhoneField extends StatefulWidget {
  ...
  /// See also:
  ///
  ///  * [EditableText.onSubmitted] for an agrofuel of how to handle moving to
  ...
  const IntlPhoneField({
    ...
    this.dropdownImage = Images.downArrow,
...
class IntlPhoneFieldState extends State<IntlPhoneField> {
  ...
  void initState() {
    ...
    if (widget.initialCountryCode == null && number.startsWith('+')) {
      ...
      number = number.substring(selectedCountry.dialCode.length);
    } else {
  ...
  Widget build(BuildContext context) {
    return
      ...
      decoration: widget.decoration.copyWith(
        ...
        // labelStyle: ThemeService().getDarkTheme() ? textBoldWhite16px : textBoldPrimary16px,
      ),
      style: widget.style,
      onSaved: (value) {
        widget.onSaved?.call(
      ...
      // },
      maxLength: widget.disableLengthCheck ? null : selectedCountry.maxLength,
  ...
  Container _buildFlagsButton() {
                ...
                if (widget.enabled &&
                    ...
                    widget.dropdownIconPosition == IconPosition.leading) ...[
                      Container(
                        ...
                        child:
                        Image.asset(widget.dropdownImage,
                          height: 20.sp,
                          width: 20.sp,
    ...
    child:
                ...
                SizedBox(width: 4.w),
                SizedBox(height: 30.h, child: VerticalDivider(color: ThemeService().getDarkTheme() ? Colors.white : Colors.black)),
                SizedBox(width: 4.w),
              ],
            ),
          ),
