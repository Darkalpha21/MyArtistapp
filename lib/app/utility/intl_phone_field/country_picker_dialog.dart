...
import 'package:my_artist_demo/app/utility/intl_phone_field/helpers.dart';
...
class CountryPickerDialogState extends State<CountryPickerDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final defaultHorizontalPadding = 40.0.sp;
    final defaultVerticalPadding = 24.0.sp;
    return Dialog(
      ...
      child: Container(
        padding: widget.style?.padding ?? EdgeInsets.all(10.sp),
        child: Column(
          children: <Widget>[
            Padding(
              padding: widget.style?.searchFieldPadding ?? EdgeInsets.all(0.sp),
              child: TextField(
